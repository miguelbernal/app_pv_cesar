mostrar_nombre_programa("Informes Inventarios");
...
async function consultar_servidor() {
    ...
    let url = `/api/v1/inventarios_cabeceras/informe/inventarios_meses?anio=${anio}`;
...
function generar_grafico(labels, datos) {
    ...
    const data = {
        labels: labels,
        datasets: [{
            label: `Inventarios por Meses del Año ${anio}`,
